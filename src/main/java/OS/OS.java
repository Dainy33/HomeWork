...
public class OS {
    ...
    private UserThread userThread2 = new UserThread("/home/dainy33/Public/USER2.txt",diskManager);
    private UserThread userThread3 = new UserThread("/home/dainy33/Public/USER3.txt",diskManager);
    private UserThread userThread4 = new UserThread("/home/dainy33/Public/USER4.txt",diskManager);
